...
interface Stats {
  ...
  linksFound: number;
  totalData: number;
  // If you have original DDoS fields (pps, bots, totalPackets), you can omit them
}
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={`px-3 py-2 rounded-lg font-semibold text-white transition-all w-full ${
                    isAttacking ? "bg-red-500 hover:bg-red-600" : "bg-emerald-500 hover:bg-emerald-600"
                ...
                <button
                  ...
                  className={`px-3 py-2 rounded-lg font-semibold text-white transition-all ${
                    isAttacking ? "bg-gray-500 hover:bg-red-600" : "bg-cyan-500 hover:bg-cyan-600"
                  } flex items-center justify-center gap-2 shadow-sm`}
                >
